    ...
    return(
        <div className="page8">
            ...
            <div className="footer">
                 <div>
                    <h2 className="h2heading">Subscribe to Our Newsletter</h2>
                    <p className="subcribeptag">Stay up-to-date with the latest trends in digital <br /> marketingand receive exclusive tips 
                        and insights by <br />subscribing to our newsletter.</p>
